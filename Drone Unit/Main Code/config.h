 ...
 * 1 - BASIC SETUP - you must select an option in ep,very block.
...
#define LAND_SPEED          100
  ...
  /********************************************************************/
    ...
    #define VBATNOMINAL     148 // 12,6V full battery nominal voltage - only used for lcd.telemetry
    #define VBATLEVEL_WARN1 140 // (*) (**) 10,7V
    #define VBATLEVEL_WARN2  130// (*) (**) 9.9V
    #define VBATLEVEL_CRIT   125 // (*) (**) 9.3V - critical condition: if vbat ever goes below this value, permanent alarm is triggered
